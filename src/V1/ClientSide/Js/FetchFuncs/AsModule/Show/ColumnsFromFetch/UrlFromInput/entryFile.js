...
const CommonRegisterCommand = "ClientSide.Js.FetchFuncs.AsModule.Show.ColumnsFromFetch.UrlFromInput";
...
const LocalFuncToActivate = async () => {
    try {
        ...
        const fetchFuncsPath = path.join(LocalToPath, "FetchAsGet", 'getUrl.json');
